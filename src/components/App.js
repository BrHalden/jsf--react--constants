...
import {WEBSITE_NAME, DOMAIN_NAME, MY_CONSTANT, USEFUL_NUMBER, ALLOW_COMMENTS} from './constants.js';
import calcCirc, {PI, calcArea} from './circles.js';
import getAndDisplay, {API_URL} from './api.js';
